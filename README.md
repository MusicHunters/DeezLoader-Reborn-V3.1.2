...
# Download Links
- Source code: [DeezLoader-3.1.2-src.zip]()
- Windows installer: [DeezLoader-3.1.2-win-64&32-installer.exe]()
- Windows x64 portable: [DeezLoader-3.1.2-win-64-portable.7z]()
